                                ...
                                <div className="flex items-center hover:bg-gray-100 -mx-8 px-6 py-5">
                                    <div className="flex w-2/5">
                                        ...
                                        <div className="flex flex-col justify-between ml-4 flex-grow">
                                            ...
                                            <div
                                               className="font-semibold hover:text-red-500 text-gray-500 text-xs cursor-pointer" onClick={()=> removeProduct(cart?.id)}>Remove</div>
                                        </div>
                                    </div>
                                    <div className="flex justify-center w-1/5">
                                        <svg onClick={() => handleDec(cart?.id)} className="fill-current text-gray-600 w-3 cursor-pointer" viewBox="0 0 448 512">
                                            <path
                                        ...
                                        <svg onClick={() => handleInc(cart?.id)} className="fill-current text-gray-600 w-3 cursor-pointer" viewBox="0 0 448 512">
